    ...
    function handleSubmit(event) {
        ...
        if (typePage == "crear") {
            $form.post(`${window.location.pathname}`, {
                // preserveState: true,
>>>>>>> c9aace69cac2381e683cdbb6116d21894c6f86c8
                onError: (errors) => {
                    if (errors.data) {
...
>
    ...
    <button
        on:click={() => {
            ...
            if (
                !$form.duration_options.some((obj) => obj.value == valueFixed)
            ) {
                let copyDurations = [...$form.duration_options];
                (copyDurations[7] = {
                    value: +valueFixed,

                    label: `${customTimePerAppointment.time} ${customTimePerAppointment.type} `,
                }),
                    ($form.duration_options = copyDurations);
            }
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <section>
                                    ...
                                    >
                                    <small
                                        >Indica qué disponibilidad sueles tener
                                        para citas</small
                                    >
                                    <ul
                                    ...
                                    {#if acordion.franja}
                                        <div class="p-2 mt-1">
                                            ...
                                            <small
                                                ...
                                                >Tiempo máximo de antelación con
                                                el que se puede reservar una
                                                cita
                                            </small>
                                            <span
                                            ...
                                            <small
                                                class="mt-4 mb-2 inline-block"
                                                >Tiempo mínimo antes del inicio
                                                de la cita para poder reservarla
                                            </small>
                                            <span
                                                class={` flex items-center gap-3`}
                                            >
                                ...
                                <section>
                                    ...
                                    >
                                        <div>
                                            ...
                                            >
                                                Gestionar las citas reservadas
                                                que aparecerán en tu calendario</small
                                            >
                                        </div>
                                    ...
                                    {#if acordion.ajustesCitasReservadas}
                                        <div class="p-2 mt-1">
                                            ...
                                            <div>
                                                <div
                                                    class="leading-5 mb-1 mt-1"
                                                >
                                                    <p
                                                        class="mt-4 inline-block font-bold"
                                                    >
                                                        Máximo de reservas por
                                                        día
                                                    </p>
                                                    <small class="inline-block">
                                                        Limitar cuántas citas
                                                        reservadas se pueden
                                                        aceptar en un día
                                                    </small>
                                                </div>
                        ...
                        <div class="mb-5">
                            ...
                            >
                                ...
                                <section class="p-2 relative">
                                    ...
                                    >
                                    <small class="mb-5 inline-block"
                                        >Agrega una nota que explique tu
                                        servicio. Esta aparecerá en tu página de
                                        reserva y en los correos electrónicos de
                                        confirmación.</small
                                    >
                                    <Editor
                                        actions={[
                                    ...
                                    >
                                        <div>
                                            ...
                                            <small
                                                class="leading-4 inline-block"
                                            >
                                                Personaliza el formulario que
                                                las personas usan para reservar
                                                una cita.</small
                                            >
                                        </div>
                                        {#if acordion.form}
